...
async function getCompletion(prompt: string): Promise<string> {
  ...
  const result = await axios({
    ...
    data,
    headers: {
      Authorization: "Bearer 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",
    },
  });
